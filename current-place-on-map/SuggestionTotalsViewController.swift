...
class SuggestionTotalsViewController: UIViewController, WKUIDelegate, WKNavigationDelegate {
    
    
    var webView : WKWebView!
    @IBOutlet var containzzView: UIView? = nil
    ...
    override func viewDidLoad() {
        ...
        let FirebaseMessageRef1 = Database.database().reference().child("webpages/SurveyMonkeyVoteCount")
